...
date: Wed Nov 20 17:25:11 CST 2024
...
<Capture_image src="https://upload.wikimedia.org/wikipedia/commons/f/f0/DEC_PDP-1_Demo_Lab_at_Mountain_View%27s_Computer_History_Museum.jpg"
               alt="PDP-1的样子，桌面上类似打字机的设备就是teletype"
               capture="PDP-1,桌面上类似打字机的设备就是teletype" />
...
> IBM当时项目负责人Frederick P. Brooks Jr.根据此项目的开发经验写出了[《人月神话：软件项目管理之道》](https://en.wikipedia.org/wiki/The_Mythical_Man-Month)

<Capture_image src="https://upload.wikimedia.org/wikipedia/commons/a/af/DM_IBM_S360.jpg"
               alt="大型机时代开山之作**IBM System/360 Model 20**，IBM当时项目负责人Frederick P. Brooks"
               capture="大型机时代开山之作IBM System/360 Model 20" />
...
<Capture_image src="https://upload.wikimedia.org/wikipedia/commons/7/77/Adm3aimage.jpg"
               alt="上图就是Bill 当时开发Vi的时候使用的设备 还是可以辨认出hjkl上是有方向键的"
               capture="上图就是Bill 当时开发Vi的时候使用的设备 还是可以辨认出hjkl上是有方向键的" />
...
<Capture_image src="https://upload.wikimedia.org/wikipedia/commons/a/a6/IBM_PC-IMG_7271_%28transparent%29.png"
               alt="IBM PC搭载了Intel的畅销CPU intel8088 @ 4.77MHz 最高可扩展出640KB的内存空间,也搭载了一个CGA用于显示图像，当时售价US$1,565"
               capture="IBM PC搭载了Intel的畅销CPU intel8088 @ 4.77MHz 最高可扩展出640KB的内存空间,也搭载了一个CGA用于显示图像，当时售价US$1,565" />
...
电脑以便学习UNIX,当时在Amiga上是没有好用的Vi，Bram
...
<Capture_image src="https://upload.wikimedia.org/wikipedia/commons/c/c3/Amiga500_system.jpg"
               alt="当时bram 使用的个人电脑"
               capture="当时bram 使用的个人电脑" />


就像**Vim**的名字一样(Vi IMproved)Vim是我们刚刚提到的bill joy开发的Vi的增强版。主要
增加了10个features 
